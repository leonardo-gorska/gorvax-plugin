    ...
    public void applyBuffs(Player player) {
        ...
        if (level >= 2) {
            try {
                ...
                plugin.getLogger().fine("Erro ao aplicar buff nível 2 da nação: " + ignored.getMessage());
            }
        }
        ...
        if (level >= 3) {
            try {
                ...
                plugin.getLogger().fine("Erro ao aplicar buff nível 3 da nação: " + ignored.getMessage());
            }
        }
    }
