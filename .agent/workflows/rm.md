...
2. Identifique o campo **"Próximo batch a executar"** na seção de Progresso Geral
3. Execute **apenas** esse batch, seguindo todas as tarefas listadas
4. Ao concluir, marque como `[x]` no ROADMAP.md e atualize o Log de Execução
5. Atualize o campo "Próximo batch a executar" para o batch seguinte
