...
class RankManagerTest {
    ...
    void gameRankDisplayNames() {
        ...
        assertTrue(RankManager.GameRank.LENDARIO.getDisplayName().contains("Lendario"));
    }

    @Test
    void gameRankGroupNames() {
        assertEquals("rank_aventureiro", RankManager.GameRank.AVENTUREIRO.getGroupName());
        assertEquals("rank_explorador", RankManager.GameRank.EXPLORADOR.getGroupName());
        assertEquals("rank_guerreiro", RankManager.GameRank.GUERREIRO.getGroupName());
        assertEquals("rank_lendario", RankManager.GameRank.LENDARIO.getGroupName());
    }
