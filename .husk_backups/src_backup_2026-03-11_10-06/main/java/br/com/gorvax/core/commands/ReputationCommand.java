...
public class ReputationCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command cmd, @NotNull String label,
        ...
        if (rep == null || !rep.isEnabled()) {
            sender.sendMessage(msg.get("karma.disabled"));
            return true;
        }
    ...
    private void showTopKarma(CommandSender sender) {
        ...
        if (dataConfig == null) {
            sender.sendMessage(msg.get("karma.data_unavailable"));
            return;
        }
        ...
        sender.sendMessage(msg.get("karma.top_heroes"));
        entries.stream()
        ...
        sender.sendMessage(msg.get("karma.top_villains"));
        entries.stream()
