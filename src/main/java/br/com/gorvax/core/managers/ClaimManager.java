                ...
                try {
                    ...
                    if (config.contains("claims." + id + ".type")) {
                        try {
                            ...
                            plugin.getLogger().fine("Tipo de claim inválido no claim " + id + ": " + e.getMessage());
                        }
                    }
                            ...
                            if (trustData instanceof List) {
                                ...
                                for (String t : types) {
                                    try {
                                        ...
                                        plugin.getLogger().fine("Trust inválido no claim " + id + ": " + e.getMessage());
                                    }
                                }
                                    ...
                                    if (tData instanceof List) {
                                        ...
                                        for (String t : types) {
                                            try {
                                                ...
                                                plugin.getLogger().fine("Trust inválido em subplot: " + e.getMessage());
                                            }
                                        }
                                        ...
                                        try {
                                            ...
                                            plugin.getLogger().fine("Migração de trust em subplot: " + e.getMessage());
                                        }
                                    }
                                }
                            }
